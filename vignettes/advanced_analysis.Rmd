...
## Metaclonotypist vs GLIPH2

Both metaclonotypist and GLIPH2 identify groups of related TCRs, but use
different algorithms:

```{r meta-vs-gliph}
# Metaclonotypist (Python-based, uses tcrdist)
seurat_meta <- runMetaclonotypist(
  immLynx_example,
  chains = "beta",
  method = "tcrdist",
  max_dist = 20,
...
# GLIPH2 (R-based turboGliph, uses motif analysis)
seurat_both <- runGLIPH(
  seurat_meta,
  chains = "TRB",
  column_prefix = "gliph"
)
...
# Compare assignments
table(metaclone = seurat_both$metaclone,
      gliph = seurat_both$gliph_cluster,
      useNA = "ifany")
```
