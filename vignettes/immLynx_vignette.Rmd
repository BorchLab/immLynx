...
- Deep learning features (DeepTCR)
...
## Deep Learning Features with DeepTCR

Extract unsupervised features using DeepTCR:
```{r deeptcr}
# Run DeepTCR VAE
seurat_obj <- runDeepTCR(
  immLynx_example,
  chains = "TRB",
...
# Access the learned features as a dimensional reduction
seurat_obj[["deeptcr"]]
```
